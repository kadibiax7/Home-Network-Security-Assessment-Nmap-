...
![network discovery scan](./screenshots/01-network-discovery.png)
...
![port scan on printer](./screenshots/04-port-scan-printer.png)
...
![service version detection](./screenshots/03-service-version-detection.png)
...
![os fingerprinting](./screenshots/05-os-fingerprinting.png)
...
![vulnerability scan](./screenshots/06-vuln-scan.png)
